...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaInflectorServerCodegen", date = "2019-01-04T20:45:03.173Z[GMT]")public class PetController  {
  /** 
  ...
  */
  ...
  /*
    public ResponseContext uploadFile(RequestContext request , Long petId , Object body ) {
        return new ResponseContext().status(Status.INTERNAL_SERVER_ERROR).entity( "Not implemented" );
    }
  */
